...
var butonQuestionsSubmit = document.querySelector('.questions .form__button');
var butonModalSubmit = document.querySelector('.questions .form__button');
...
headerButton.addEventListener('click', function (evt) {
  ...
  if (window.screen.height < 757) {
    modal.style.height = "".concat(757 - window.screen.height, "px");
  } else {
...
butonQuestionsSubmit.addEventListener('submit', function () {
...
butonModalSubmit.addEventListener('submit', function () {
